...
const post = projectPosts.find((item) => item.id === "3-axis-chassis-module");
            ...
            <main className="mx-auto max-w-6xl py-14">
                ...
                <div>
                    ...
                    <ul className="list-disc pl-5">
                        <li>
                            <p className="mt-2 text-lg leading-8 text-zinc-300">The desire to <strong className="text-cyan-300">optimize the budget</strong>, including <strong className="text-cyan-300">off-the-shelf swerve module</strong>, for future project</p>
                        </li>
                        <li>
                            <p className="mt-2 text-lg leading-8 text-zinc-300">Controlling <strong className="text-cyan-300">part of the product’s weight</strong> to increase the <strong className="text-cyan-300">durability</strong> of the product</p>
                        </li>
                        <li>
                            <p className="mt-2 text-lg leading-8 text-zinc-300">Being <strong className="text-cyan-300">flexible</strong> to both <strong className="text-cyan-300">firmware and hardware</strong>, depending on the <strong className="text-cyan-300">project’s scope</strong></p>
                        </li>
                    </ul>
                    {/* II */}
