...
export const projectPosts: PostEntry[] = [
  {
    ...
    summary: "An off-season project building a <strong>virtual prototype for the FTC 2025–2026 season: DECODE</strong>. This season’s goal was to engineer an elite-level robot architecture that optimize 3 factors: <strong>Fast</strong> and <strong>flexible</strong> intake, <strong>Smooth</strong> and <strong>rapid</strong> transfer, <strong>Stable</strong> and <strong>precise</strong> shooter",
    description:
    ...
    skills: ["3D Modeling", "2D Design", "Brainstorming", "Researching"],
    category: "project",
